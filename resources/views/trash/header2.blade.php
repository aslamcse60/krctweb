...
<div class="row">
    <div class="col-lg-4 col-sm-12 col-md-12 col-xl-5">
        <nav class="navbar navbar-light ">
                <img src="images/logo.jpg" width="450" height="160" class="navbar-brand img-responsive logoss mx-lg-2" alt="">
        </nav>
    </div>
    <div class="col-lg-8 col-sm-12 col-md-12 col-xl">
        <div class="row">
            <nav class="navbar navbar-light ">
            <nav class="navv">
        ...
        <div class="row menuredlinecol2">
            <ul class="navbar nav flex-wrap  justify-content-start ">
                <li>
                    <a style="padding-left: 10px"href="#">ARIIA</a>
                    <a href="#">UPGRAD CAMPUS</a>
                    <a href="#">CAREERS</a>
                    <li class="nav-item dropdown" id="hello2">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                          BLOG
                        </a>
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                          <li><a class="dropdown-item" href="#">ARTIFICIAL INTELLIGENCE VS MACHINE LEARNING VS DATA SCIENCE</a></li>
                          <li><a class="dropdown-item" href="#">MECHANICAL BLOG</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown" id="hello2">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                          <li><a class="dropdown-item" href="#">ONLINE FEE PAYMENT</a></li>
                        </ul>
                    </li>
                </li>
            </ul>
